...
export default function BikeSpecs({ bike }: BikeSpecsProps) {
  const specs = [
    ...
    {
      label: 'Seat Capacity',
      value: `${bike.seatCapacity} Persons`,
      icon: (
        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="bg-[#111827] rounded-3xl p-8 border border-gray-700/50">
      <h3 className="text-xl font-heading font-semibold text-white mb-6">Technical Specifications</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {specs.map((spec, index) => (
          <div key={index} className="flex items-start gap-4">
            ...
            <div>
              <p className="text-gray-400 text-sm mb-0.5">{spec.label}</p>
