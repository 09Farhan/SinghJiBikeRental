  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4">
        {placeholders.map((gradient, idx) => (
          <button
            key={idx}
            onClick={() => setSelectedIndex(idx)}
            className={cn(
              "relative h-24 rounded-2xl overflow-hidden flex items-center justify-center bg-gradient-to-br border-2 transition-all duration-300",
              gradient,
