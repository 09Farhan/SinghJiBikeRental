        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {reviews.map((t) => (
              <div 
                key={t.id}
                className="bg-[#111827] border border-gray-700/50 rounded-2xl p-6 relative overflow-hidden group hover:border-orange-500/30 transition-colors flex flex-col h-full"
              >
                {/* Decorative Quote Mark */}
                <div className="absolute -top-4 -right-2 text-9xl text-orange-500/10 font-heading leading-none select-none group-hover:text-orange-500/20 transition-colors">
                  "
                </div>
